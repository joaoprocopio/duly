  ...
  server.config({
    routes() {
      ...
      this.get("/current/", function (schema) {
        ...
        if (!cookie)
          return new Response(200, {}, AuthSerializer.notAuthenticated())
        ...
        return new Response(200, {}, AuthSerializer.authenticated(user))
      })
      ...
      this.post("/identify/", function (schema, request) {
        ...
        return new Response(200, {}, AuthSerializer.findUser(user))
      })
